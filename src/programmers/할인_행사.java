...
public class 할인_행사 {
    public static void main(String[] args) {
        ...
        System.out.println(할인_행사.solution(new String[]{"banana", "apple", "rice", "pork", "pot"},
                new int[]{3, 2, 2, 2, 1},
                new String[]{"chicken", "apple", "apple", "banana", "rice", "apple", "pork", "banana", "pork", "rice", "pot", "banana", "apple", "banana"}));

        System.out.println(할인_행사.solution(new String[]{"apple"},
                new int[]{10},
    ...
    private static int solution(String[] want, int[] number, String[] discount) {
        ...
        for (int i = 0; i < discount.length - 9; i++) {
            ...
            for (int j = 0; j < 10; j++) {
                String nowKey = discount[i + j];
                map.put(nowKey, map.getOrDefault(nowKey, 0) + 1);
            }

            if (isValid(want, number, map)) {
                answer++;
            }
    ...
    private static boolean isValid(String[] want, int[] number, Map<String, Integer> map) {
